#!/bin/bash
echo "Cloning SPECTRE repo"
git clone --recurse-submodules -j4 https://github.com/SegevBar/couples-expression-comparison-models.git
cd ./couples-expression-comparison-models/SPECTRE/
