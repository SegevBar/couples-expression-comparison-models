...
from EMOCA.emoca_model.gdl.transforms.keypoints import KeypointScale, KeypointNormalization
...
class EmotionalImageDatasetBase(torch.utils.data.Dataset):
    ...
    def _plot(self, axs, K, k, sample):
        ...
        from EMOCA.emoca_model.gdl.utils.DecaUtils import tensor_vis_landmarks
