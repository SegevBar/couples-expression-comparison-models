...
class LipReadingNet(torch.nn.Module):
    ...
    def forward(self, lip_images):
        ...
        # EMOCA.emoca_model.gdl/external/spectre/external/Visual_Speech/espnet/nets/pytorch_backend/backbones/conv3d_extractor.py
        # line 95:
    ...
    def forward_old(self, lip_images):
        ...
        # In other words, in the lip reading repo code, the following happens:
        # EMOCA.emoca_model.gdl/external/spectre/external/Visual_Speech_Recognition_for_Multiple_Languages/espnet/nets/pytorch_backend/backbones/conv3d_extractor.py
        # line 95:
