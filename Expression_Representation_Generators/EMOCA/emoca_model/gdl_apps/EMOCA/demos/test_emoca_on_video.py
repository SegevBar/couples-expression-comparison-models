...
def reconstruct_video(args):
    ...
    if args.logger == "wandb":
        from EMOCA.emoca_model.gdl_apps.EMOCA.training.test_and_finetune_deca import  create_logger, project_name
        import wandb
...
def parse_args():
    ...
    parser.add_argument('--input_video', type=str, default=str(Path(EMOCA.emoca_model.gdl.__file__).parents[1] / "data/EMOCA_test_example_data/videos/82-25-854x480_affwild2.mp4"),
    ...
    parser.add_argument('--path_to_models', type=str, default=str(Path(EMOCA.emoca_model.gdl.__file__).parents[1] / "assets/EMOCA/models"))
