...
def main():
    ...
    parser.add_argument('--input_folder', type=str, default= str(Path(EMOCA.emoca_model.gdl.__file__).parents[1] / "assets/data/EMOCA_test_example_data/images/affectnet_test_examples"))
