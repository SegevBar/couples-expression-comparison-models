...
class SpectreExpGenerator:
    ...
    def extract_frames(self, detect_landmarks=True):
        ...
        if detect_landmarks is True:
            from SPECTRE.spectre_model.external.Visual_Speech_Recognition_for_Multiple_Languages.tracker.face_tracker import FaceTracker
            from SPECTRE.spectre_model.external.Visual_Speech_Recognition_for_Multiple_Languages.tracker.utils import get_landmarks
    ...
    def crop_face_f(self, frame, landmarks, scale=1.0):
        image_size = 224
    ...
    def generate_expressions_representation(self):
        print("spectre start")
        crop_face = True
        spectre_cfg.pretrained_modelpath = "SPECTRE/spectre_model/pretrained/spectre_model.tar"
        ...
        with torch.no_grad():
            ...
            for chunk_id in range(len(overlapping_indices)):
                ...
                for j in range(len(image_paths_chunk)):
                    ...
                    tform = self.crop_face_f(frame, kpt, scale=1.6)
